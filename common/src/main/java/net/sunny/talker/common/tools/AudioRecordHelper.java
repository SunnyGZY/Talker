package net.sunny.talker.common.tools;
    ...
    */
    ...
    private File record() {
        ...
        while (true) {
            ...
            getVolume(readSize, buffer, callback);
     ...
     */
    private void getVolume(double readSize, short[] buffer, RecordCallback callback) {
        long v = 0;
