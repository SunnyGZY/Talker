 ...
 */
public class OkRecycleviewRefreshHeadView extends LinearLayout {
    //刷新头布局
    ...
    public OkRecycleviewRefreshHeadView(Context context) {
        super(context);
        initView(context);
    }

    public OkRecycleviewRefreshHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
