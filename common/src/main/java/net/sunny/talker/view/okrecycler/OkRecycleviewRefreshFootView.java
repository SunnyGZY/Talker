...
import net.sunny.talker.view.okrecycler.load.CircleLoadingView;


/**
 * Created by yukuo on 2016/4/30.
 */
public class OkRecycleviewRefreshFootView extends LinearLayout {
    ...
    public OkRecycleviewRefreshFootView(Context context) {
        super(context);
        initView(context);
    }

    public OkRecycleviewRefreshFootView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
