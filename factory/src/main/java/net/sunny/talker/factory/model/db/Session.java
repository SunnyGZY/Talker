...
public class Session extends BaseDbModel<Session> {
    ...
    public Session copy() {
        ...
        copySession.id = this.id;
        copySession.picture = this.picture;
        copySession.title = this.title;
        copySession.content = this.content;
        copySession.receiverType = this.receiverType;
        copySession.unReadCount = this.unReadCount;
        copySession.modifyAt = this.modifyAt;
        copySession.message = this.message;
